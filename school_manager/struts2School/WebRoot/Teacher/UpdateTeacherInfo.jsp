...
<%@ page import="com.struts2.model.CteacherBean" %>
<% 
String userID=String.valueOf(((CteacherBean)request.getSession().getAttribute("teacher")).getT_id());
...
<body>
<form name="updateTf" method="post" action="../user/Teacher_updateSuccess">
