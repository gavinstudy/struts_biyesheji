	...
	<TBODY>
		...
		<TR>
			...
			<TABLE cellSpacing=0 cellPadding=0 width=150 align=center>
				<TBODY>
					<TR>
						<TD bgColor=#COCOCO height=20>◎<A href="../user/Teacher_addtestServlet"
							target="mainFrame"> 增加必修课试题 </A></TD>
					</TR>
					<TR>
						<TD bgColor=#A9A9A9 height=20>◎ <A
							href="../user/Teacher_addtest2Servlet" target=mainFrame>增加选修课试题</A></TD>
					</TR>
					<TR>
						<TD bgColor=#A9A9A9 height=20>◎ <A
							href="..//user/Teacher_excamUploadOrDeleteTestServlet" target=mainFrame>修改及删除试题</A></TD>
					</TR>
					<TR>
						<TD bgColor=#000000 height=20>◎ <A href="http://www.i2030.org"
							target=mainFrame class="STYLE1">扩展功能 </A></TD>
