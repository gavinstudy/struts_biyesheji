					...
					<TBODY>
						<TR>
							<TD bgColor=#COCOCO height=20>◎<A
								href="../user/Student_show" target="mainFrame">
							我的信息 </A></TD>
						</TR>
						<TR>
							<TD bgColor=#COCOCO height=20>◎<A
								href="../user/Student_update" target="mainFrame">
							修改信息 </A></TD>
						</TR>
						<TR>
			...
			<TR>
				...
				<TABLE cellSpacing=0 cellPadding=0 width=150 align=center>
					<TBODY>
						<TR>
							<TD bgColor=#COCOCO height=20>◎<A
								href="../user/Student_courseTable" target="mainFrame">
							必修课课表 </A></TD>
						</TR>
						
						<TR>
							<TD bgColor=#000000 height=20>◎ <A href="../user/Student_personalXuanXiu"
			...
			<TR>
				...
				<TABLE cellSpacing=0 cellPadding=0 width=150 align=center>
					<TBODY>
						<TR>
							<TD bgColor=#COCOCO height=20>◎<A
								href="../user/Student_bixiuChengJi" target="mainFrame">
							必修课成绩查询 </A></TD>
						</TR>
						
						<TR>
							<TD bgColor=#000000 height=20>◎ <A href="../user/Student_xuanxiuChengJi"
			...
			<TR>
				...
				<TABLE cellSpacing=0 cellPadding=0 width=150 align=center>
					<TBODY>
						<TR>
							<TD bgColor=#COCOCO height=20>◎<A
								href="../user/Student_xuanbaoCourse" target="mainFrame">
							选报课程 </A></TD>
						</TR>
			...
			<TR>
				...
				<TABLE cellSpacing=0 cellPadding=0 width=150 align=center>
					<TBODY>
						<TR>
							<TD bgColor=#COCOCO height=20>◎<A
								href="../user/Student_bixiuKaoShi" target="mainFrame">
							必修考试 </A></TD>
						</TR>
						<TR>
							<TD bgColor=#A9A9A9 height=20>◎ <A
								href="../user/Student_xuanxiuKaoShi"
